...
botaoanterior.addEventListener('click', fotoanteroior);
...
function proximafoto() {
    ...
    slide.src = servidorDasImagens + '/' + imagens[contador]['arquivo'];
    slide.alt = imagens[contador]['descricao'];

}

function fotoanteroior() {
    contador = contador - 1;
    let slide = document.querySelector("#slide");
    if (contador < 0) {
        contador += imagens.length;
